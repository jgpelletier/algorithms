...
var _ = require("../node_modules/underscore/underscore-min.js") // <-relative path
...
string = string.split(" ") // <- creates an array
//console.log(string)
var toMultiply = 4
var grid = []
for (var x = 0; x < 20; x++) {
    grid.push([]) // pushes array on to the array
    for (var y = 0; y < 20; y++) {
        grid[x].push(parseInt(string.shift(), 10)) // fills the array
    }
}
