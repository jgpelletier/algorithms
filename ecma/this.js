...
//    there.
//    
//    `this` Precedence: Taken from You don't know JS
...
//
//    Is the function called with a context (implicit binding), otherwise known as an owning or containing
//    object? If so, this is that context object.
//
//    var bar = obj1.foo()
//
//    Otherwise, default the this (default binding). If in strict mode, pick undefined, otherwise pick the
//    global object.
//
//    var bar = foo()
